...
function Header(){
  ...
  useEffect(()=>{
    ...
    <div className="header">
        ...
        <Popup trigger={<img alt="spin" className="profile" src="https://cdn.discordapp.com/attachments/1096324843877703713/1148912645374758953/image.png"/>} position="right top" ><Profile/></Popup>
